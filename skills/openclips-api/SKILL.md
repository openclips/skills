...
description: >-
  ...
  openclips-video-ads, openclips-clips, openclips-edit,
  openclips-competitor-recreate, openclips-catalog-setup,
...
- **Where to read:** `https://api.openclips.ai/openapi.json` is the machine-readable schema and `https://api.openclips.ai/docs` the reference; `https://api.openclips.ai/llms.txt` indexes the guides (authentication, quickstart, jobs and polling, credits and previews, errors). Link them rather than fetching or retyping them.
